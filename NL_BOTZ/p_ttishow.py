...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🌿 ɢʀᴏᴜᴘ', url='https://t.me/asiandramagroup1')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        for u in message.new_chat_members:
                buttons = [[
                InlineKeyboardButton('🔰 ɢʀᴏᴜᴘ ʀᴜʟᴇs 🔰', url="https://telegra.ph/Rules-of-Group-08-21")
            ]]
                ...
                video="https://telegra.ph/file/cce7effdf8abd8b6543f1.jpg",
